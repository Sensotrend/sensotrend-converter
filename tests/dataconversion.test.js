...
import { NightscoutDataProcessor } from '../src/templates/nightscout';
import { FIPHRDataProcessor } from '../src/templates/fiphr';
import { TidepoolDataProcessor } from '../src/templates/tidepool';
...
const DataConverter = new DataFormatConverter(logger);
